...
insert into products(name, price, image, description, qtd) values ("Whey gold 1KG", 130.90, "images/wheygold.jpg", "A Whey Gold 100% Protein ON é uma proteína de alto valor biológico e é muito usada por atletas de rendimento, praticantes de atividade física e até idosos que pretendem minimizar a perda muscular que ocorre com o processo de envelhecimento.", 10);
  ...
  insert into usuario(nome, sobrenome, cpf, contato, email, senha, estado_id, cidade_id, bairro_id, rua_id, tipousuario_id) values ("Marcos", "Roberto", 123456, 3333333, "admin", "admin", 1, 1, 5, 1, 1);
  insert into usuario(nome, sobrenome, cpf, contato, email, senha, estado_id, cidade_id, bairro_id, rua_id, tipousuario_id) values ("Fausto Silva", "Silva", 123456, 3333333, "fausto", "fausto", 2, 3, 2, 4, 3);
